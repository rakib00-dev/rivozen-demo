            ...
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
              <div>
                ...
                <p className="mt-5 leading-relaxed text-muted-foreground">
                  You don't need to know exactly what service you need. Tell us
                  what's not working and we'll help figure out the creative
                  solution.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-6xl">
          <Reveal>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
                No unnecessary complexity. Just a clear process designed to keep
                the work moving.
              </p>
            </div>
          </Reveal>
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-8 md:p-12 lg:p-16">
                  ...
                  <p className="mt-6 leading-relaxed text-muted-foreground">
                    ...
                    looks. Every decision is made to help your brand communicate
                    more clearly and create a stronger connection with its
                    audience.
                  </p>
          ...
          <RevealStagger className="mt-12 grid gap-5 md:grid-cols-2">
            <RevealItem>
              <div className="h-full rounded-2xl border border-border bg-card p-8">
                ...
                <p className="mt-3 leading-relaxed text-muted-foreground">
                  ...
                  creative output without the cost and complexity of building an
                  internal team.
                </p>
            ...
            <RevealItem>
              <div className="h-full rounded-2xl border border-border bg-card p-8">
                ...
                <p className="mt-3 leading-relaxed text-muted-foreground">
                  Need a website, brand identity, campaign, or specific creative
                  project? We can work with you from concept to final delivery.
                </p>
        ...
        <div className="mx-auto max-w-4xl">
          <Reveal>
            <div className="text-center">
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-tight md:text-6xl">
                A few things you
                <span className="font-serif italic"> might be wondering.</span>
              </h2>
            </div>
          </Reveal>
