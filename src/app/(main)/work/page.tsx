        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <Reveal delay={0.16}>
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground md:text-xl">
              ...
              systems built to help ambitious brands stand out and move forward.
            </p>
          </Reveal>
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center p-8 md:p-12 lg:p-16">
                  ...
                  <p className="mt-6 leading-relaxed text-muted-foreground">
                    Flowstate needed a digital presence that could communicate a
                    complex product in a simple, confident way. We created a
          ...
          <Reveal>
            <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
              ...
              <p className="max-w-md text-muted-foreground">
                Different industries, different challenges, one consistent goal:
                creating work that has a reason to exist.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-tight md:text-6xl">
                Good work speaks.
                <br />
                <span className="font-serif italic">Great clients do too.</span>
              </h2>
            </div>
          </Reveal>
