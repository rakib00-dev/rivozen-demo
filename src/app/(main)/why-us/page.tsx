        ...
        <div className="relative mx-auto max-w-6xl">
          <Reveal>
            ...
            <motion.div
              ...
              className="mt-8 flex flex-wrap gap-3"
            >
              <Button type="button" size="lg" onClick={scrollToDifferentiators}>
                Why choose us
          ...
          <Reveal>
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl leading-relaxed text-muted-foreground">
                Good work is important. But how you get there matters too. We've
                built our process around making collaboration easier, clearer,
                and more effective.
              </p>
            </div>
          </Reveal>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
              <div>
                ...
                <p className="mt-5 max-w-md leading-relaxed text-muted-foreground">
                  ...
                  Our approach keeps things focused from the first conversation
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-3 text-balance text-4xl font-semibold tracking-tight md:text-5xl">
                  ...
                  <span className="font-serif italic text-primary">easy.</span>
                </h2>
