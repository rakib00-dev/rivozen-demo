            ...
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
              <div>
                ...
                <p className="mt-5 max-w-md leading-relaxed text-muted-foreground">
                  No complicated onboarding or lengthy approval processes. Send
                  us what you need and we'll take it from there.
                </p>
              </div>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-7 md:p-10 lg:p-14">
              ...
              <div className="relative grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-20">
                <div>
                  ...
                  <p className="mt-5 max-w-md leading-relaxed text-muted-foreground">
                    No problem. We also work with clients on individual projects
                    when a monthly subscription isn't the right fit.
                  </p>
