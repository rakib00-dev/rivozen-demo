                ...
                <div className="relative overflow-hidden border-b border-border p-6 md:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-4 max-w-md leading-relaxed text-muted-foreground">
                      Have an idea, a project, or a design challenge? Send us a
                      message and we&apos;ll get back to you with the next
                      steps.
                    </p>
                    ...
                    <div className="mt-12 border-t border-border pt-6">
                      ...
                      <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                        If you&apos;d rather talk through your project, you can
