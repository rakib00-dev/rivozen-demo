    ...
    >
      ...
      <div className={`mx-auto mt-16 max-w-6xl`}>
        <div className="grid grid-cols-2 gap-10 md:grid-cols-5">
          <div className="col-span-2">
            <a href="#top" className="flex items-center gap-2">
              ...
              <Image
                src={`${pathname === "/book-a-call" ? "/rivozen_white.png" : "/rivozen_black.png"}`}
                alt="hero section"
                width={40}
                height={40}
              ...
              <ul className="mt-4 space-y-2.5">
                {c.links.map((l) => (
                  <li key={l}>
                    <a
                      href="#"
                      className={`text-sm text-muted-foreground transition-colors ${pathname === "/book-a-call" ? "hover:text-gray-700" : "hover:text-foreground"}`}
                    >
                      {l}
                    </a>
                  </li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border py-6 text-sm text-muted-foreground sm:flex-row">
          <p>
            © {new Date().getFullYear()} Rivozen Studio. All rights reserved.
          </p>
